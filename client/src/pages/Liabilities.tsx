...
export default function LiabilitiesPage() {
  ...
  const filteredLiabilities = liabilities.filter((liability: Liability) => {
    const matchesSearch = liability.liabilityName.toLowerCase().includes(searchTerm.toLowerCase());
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Track and manage company liabilities</p>
          </div>
        </div>
        <Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Company Liabilities</CardTitle>
            ...
            <table className="data-table">
              ...
              <tbody>
                {filteredLiabilities.length === 0 ? (
                  ...
                  filteredLiabilities.map((liability: Liability) => (
                    <tr key={liability.id}>
                      <td>
                      ...
                      <td>
                        <Badge className={`status-badge ${getStatusColor(liability.status)}`}>
                          {liability.status}
                        </Badge>
                      </td>
                      <td>
